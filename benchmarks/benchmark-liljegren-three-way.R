...
# row-aligned coordinates, so this historical comparison intentionally uses one
# fixed coordinate pair. Timestamps remain unique, making every
# (timestamp, lon, lat) triplet distinct.
